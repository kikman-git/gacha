...
export default class Lack extends Component {
  ...
  render() {
    if (sessionStorage.getItem('gacha_chances') > 0) {
        ...
        <div className="main-section">
          <div className="container">
            <div className="box">
              ...
              <p>
                Note: every customer will get a free chance after login every
                day
              </p>
              <br />
              <Button
                ...
                variant="contained"
                color="primary"
                onClick={this.GetAdiitionalChance}
              >
                Get Additioal Chance
              </Button>
              <br />
              <br />
            </div>
